...
#define _EMA_ALPHA 0.2    // EMA weight of new sample (range: 0 to 1), 0.5에서 0.2로 수정
...
#define _DUTY_MIN 500 // servo full clockwise position (0 degree), 1000에서 500으로 수정
#define _DUTY_NEU 1500 // servo neutral position (90 degree)
#define _DUTY_MAX 3200 // servo full counterclockwise position (180 degree), 2000에서 3200으로 수정
...
void loop() {
  ...
  if ((dist_ema < _DIST_MIN)) {
    //myservo.writeMicroseconds(_DUTY_MIN); //_TARGET_LOW _DIST_MIN
  } else if (dist_ema > _DIST_MAX) {
    //myservo.writeMicroseconds(_DUTY_MAX);  //_TARGET_HIGH _DIST_MAX
  } else {    // In desired Range
